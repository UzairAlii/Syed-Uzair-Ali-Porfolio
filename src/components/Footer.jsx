...
const Footer = () => {
  return (
    <footer className="w-full bg-[#000000f3] text-[#ffffffd9] py-4 px-4 text-center sm:text-left">
      <div className=" mx-auto flex flex-col items-center sm:items-start gap-4">
        ...
        <div className="flex flex-col w-full items-center">
          ...
          <div className="flex items-center text-gray-800 mt-1">
            ...
            <span className="text-sm text-[#ffffffd9] font-extralight">uzairali.services@gmail.com</span>
          </div>
        </div>
        ...
        {/* Footer Bottom Row */}
        <div className="w-full flex flex-col sm:flex-row justify-between gap-5 items-center text-sm text-[#ffffffd9]">
          <p className='font-extralight'>
            © {new Date().getFullYear()} <span className='font-semibold'>Syed Uzair Ali</span>, All rights reserved.
          </p>

          <div className='flex items-center gap-5'>
            <a href="https://github.com/UzairAlii" target="_blank" rel="noopener noreferrer">
              <img src={Images.github} alt='GitHub' className='w-5 invert' />
            </a>
            <a href="https://www.linkedin.com/in/syed-uzair-ali-5ab504294?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer">
              <img src={Images.linkedIn} alt='LinkedIn' className='w-6 invert' />
            </a>

            <a href="https://www.facebook.com/share/1ELT9FvjCf/?mibextid=qi2Omg" target="_blank" rel="noopener noreferrer">
              <img src={Images.fb} alt='Facebook' className='w-5 invert' />
            </a>
            <a href="https://www.instagram.com/syed.uzair.ali01?igsh=MWludGh0dmN3a2dzOA==" target="_blank" rel="noopener noreferrer">
              <img src={Images.insta} alt='Instagram' className='w-4 invert' />
            </a>


          </div>
          <div className="flex gap-4">
            <Link to="/terms-of-services" className="hover:underline font-extralight">Terms of Services</Link>
            <Link to="/privacy-policy" className="hover:underline font-extralight">Privacy Policy</Link>
          </div>
        </div>
      </div>
    </footer>
